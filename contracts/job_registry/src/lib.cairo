...
// fn main() {
//     use starknet::contract::deploy;
//     // This is the entry point for the Starknet contract.
//     // The contract will be deployed and initialized here.
//     starknet::contract::deploy(job_registry::JobRegistry::default());
// }
