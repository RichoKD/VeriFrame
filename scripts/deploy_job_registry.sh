...
# FluxFrame Job Registry Deployment Script
...
if [ ! -f "target/dev/fluxframe_job_registry_JobRegistry.contract_class.json" ]; then
...
cat > "$DEPLOYMENT_FILE" << EOF
{
  ...
  "abi_path": "target/dev/fluxframe_job_registry_JobRegistry.contract_class.json"
}
EOF
...
# FluxFrame Worker Environment Variables
